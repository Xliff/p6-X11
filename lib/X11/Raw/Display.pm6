...
sub XInternAtom (Display $var0, Str $var1, realInt $var2)
  returns Atom
  is native(x11)
  is export
{ * }
...
sub XListHosts (Display $var0, realInt $var1 is rw, realInt $var2)
...
sub XRegisterIMInstantiateCallback (
  Display       $var0,
  XrmHashBucket $var1,
  Str           $var2,
  Str           $var3,
...
sub XSetGraphicsExposures (Display $var0, GC $var1, realInt $var2)
  returns realInt
  is native(x11)
  is export
{ * }
...
sub XSetIOErrorExitHandler (
  Display             $var0,
  XIOErrorExitHandler $var1,
  Pointer             $var2
)
  is native(x11)
  is export
...
sub XUnregisterIMInstantiateCallback (
  Display       $var0,
  XrmHashBucket $var1,
  Str           $var2,
  Str           $var3,
